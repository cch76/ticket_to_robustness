...
parser.add_argument('--depth', default=34, type=int, metavar='D',
                    help='model depth')
...
def main():
    ...
    val_loader = data.DataLoader(testset, batch_size=args.batch_size, shuffle=False, num_workers=args.workers)
